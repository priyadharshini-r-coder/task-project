...
import com.example.taskproject.databinding.ActivityMain2Binding;
import com.example.taskproject.model.UserModel;
...
public class MainActivity2 extends AppCompatActivity implements View.OnClickListener {
   ActivityMain2Binding binding;
    ...
    private void doDeleteUserProfileImage() {
        FirebaseStorage.getInstance().getReference()
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(MainActivity2.this, "Profile IMage Deleted Successfully", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void getUserPermission() {
        if ((ActivityCompat.checkSelfPermission(MainActivity2.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED)) {
            selectImage();
        } else {
            ActivityCompat.requestPermissions((Activity) MainActivity2.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 22);
        }
    }
                ...
                reference.putFile(data.getData())
                        .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                progressDialog.dismiss();
                                Toast.makeText(MainActivity2.this, "Profile Uploaded Successfully", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
            else{
